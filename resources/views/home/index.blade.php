<x-app-layout>
    <div class="py-16 overflow-hidden lg:py-24 p-10">
        <div class=" max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
            <div class="relative">
                <h2 class="text-center text-4xl leading-8 font-extrabold tracking-tight text-white sm:text-6xl">Encuentra un trabajo en Tech de forma remota</h2>
