                        ...
                        <ul class="divide-y divide-gray-200 w-full">
                            @forelse ($vacante->candidatos as $candidato)
                                <li class="p-3 flex items-center">
                                    <div class="flex-1">
                                        <p class="text-xl text-white font-medium text-gray-800">
                                            {{ $candidato->user->name}}
                                        </p>
                                        <p class="text-sm text-white text-gray-600">
                                           Email: {{ $candidato->user->email}}
                                        </p>
                                        <p class="text-sm font-medium text-white text-gray-600 ">
                                    ...
                                    <div>
                                        ...
                                        href="{{ asset('storage/cv/' . $candidato->cv) }}"t
                                        target="_blank"
